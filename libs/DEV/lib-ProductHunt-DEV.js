...
class ProductHunt {
    ...
    async login(page, sessionCookie) {
        ...
        const _login = async () => {
            ...
            const className = await (await sel.getProperty("className")).jsonValue();
            console.log("className:", className);
            if (className === SELECTORS.LOGGED) {
        ...
        try {
            ...
            if (lib_api_store_DEV_1.isUnknownObject(ao) && ao.sessionCookie) {
