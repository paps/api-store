...
const getFollowers = async (tab, url, numberMaxOfFollowers, resuming) => {
	...
	try {
		...
		console.log("err:", err)
		await tab.screenshot(`${Date.now()}relm.png`)
		await buster.saveText(await tab.getContent(), `${Date.now()}relm.html`)
