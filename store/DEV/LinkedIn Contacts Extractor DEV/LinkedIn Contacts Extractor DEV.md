...
This API can extract in a few minutes your first degree connections (up to 2-3k profiles). Use it to track who you're connected to and how is your network evolving.
You can also use a LinkedIn Contacts spreadsheet (downloading your contacts list from [https://www.linkedin.com/psettings/member-data]https://www.linkedin.com/psettings/member-data) to full extract the your contacts profile URLs.
