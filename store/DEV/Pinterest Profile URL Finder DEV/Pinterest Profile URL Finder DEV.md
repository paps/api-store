# Use names and or company names to find Pinterest profiles 🔍

How are your competitors doing on social media platforms? Looking for Pinterest pages of a list of contacts? 

Starting from a spreadsheet filled with a list of names (and/or company names), Phantombuster will use search engines to automatically match names with their Pinterest profile URLs.
...
In order to match your search query with an Pinterest profile our API will use different search engines such as Google, Duckduckgo, Bing, Ecosia...
