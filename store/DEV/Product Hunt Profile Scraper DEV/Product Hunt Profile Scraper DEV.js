...
const lib_StoreUtilities2_DEV_1 = __importDefault(require("./lib-StoreUtilities2-DEV"));
const utils = new lib_StoreUtilities2_DEV_1.default(buster);
const DB_NAME = "result";
const LINES_COUNT = 10;
// }
const isProductHuntUrl = (url) => {
    try {
