# Find out who is followed by a Twitter account 🐦
The 1st step in order to know who is following a specific Twitter account is to actually list the followers. With this API, choose your own or any Twiter account and get in seconds a clear listing of every follower, including their own:
* Twitter Profile Url
* Full Name
* Bio
...
<center>![](https://s3-eu-west-1.amazonaws.com/phantombuster-static/api-store/configure_me.JPG)</center>
...
<center>![](https://s3-eu-west-1.amazonaws.com/phantombuster-static/api-store/twitter_follower_collector/auth_token_1.png)</center>

* Locate the “`auth_token`” cookie.

<center>![](https://s3-eu-west-1.amazonaws.com/phantombuster-static/api-store/twitter_follower_collector/auth_token_2.png)</center/>
